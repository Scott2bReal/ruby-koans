...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # 
    # Inject uses a block with two parameters; an accumulator and the current
    # item of the collection. The block is executed on every iteration through
    # the collection, and the accumulator is returned.
  end
  ...
  #   # code to read 'file'
  #
  #   When File#open is called without a block, it executes File#new. When it is
  #   called with the optional block, however, the block is passed the file as
  #   an argument, and will automatically close the file upon completion.
  #
